...
const uri = `mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASSWORD}@cluster0.yapakru.mongodb.net/?retryWrites=true&w=majority`;
...
async function run() {
  try {
    const appointmentOptionCollection = client.db("UseProduct").collection("optionCollection");
    ...
    const productsCollection = client.db("UseProduct").collection("products");
